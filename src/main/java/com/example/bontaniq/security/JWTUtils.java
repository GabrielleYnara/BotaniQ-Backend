...
/**
 * Service utility class for generating and validating JWT tokens.<br>
...
public class JWTUtils {
    ...
    /**
     * The secret key used for signing JWT tokens.<br>
    ...
    /**
     * The expiration time for JWT tokens, specified in milliseconds.<br>
     * This value is populated from application properties via the @Value annotation.
     */
